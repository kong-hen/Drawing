        ...
        <div class="content-wrapper">
              ...
              <div class="d-flex justify-content-between flex-wrap">
                <div class="d-flex align-items-end flex-wrap">
                  ...
                  <div class="d-flex">
                    ...
                    <p class="text-primary mb-0 hover-cursor">头像</p>
                  </div>
                </div>
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                  <button class="btn btn-primary mt-2 mt-xl-0"><a href="./upload.php" style="text-decoration: none;"><font color=white>上传头像</font></a></button>
                </div>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 style="font-size: 20px !important;" class="card-title">头像管理</h4>
